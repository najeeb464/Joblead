"""
Django settings for joblead project.
...
# SECRET_KEY = 'django-insecure-q(lb3-3)7q4kljn-j=3-^yggo(u09i^nzeeilol7t9xjz&-yiy'

# # SECURITY WARNING: don't run with debug turned on in production!
# DEBUG = True

# ALLOWED_HOSTS = []
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "jango-insecure-q(lb3-3)7q4kljn-j=3-^yggo(u09")
...
WSGI_APPLICATION = 'joblead.wsgi.application'
